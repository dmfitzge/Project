...
public class FlightsMRJob1Reducer extends
	...
	public void reduce(Text key, Iterable<IntWritable> values, Context context)
		...
		put.addColumn("colfam1".getBytes(), "AIRLINE".getBytes(), Bytes.toBytes(key.toString()));
		put.addColumn("colfam1".getBytes(), "avgArrivalDelay".getBytes(), Bytes.toBytes(Integer.toString(average)));
